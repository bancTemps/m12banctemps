...
@section('content')
	...
	{{-- Edit Service Form --}}
	<form class="form-horizontal" method="post" action="{{ URL::to('user/services/' . $servicio->id . '/edit') }}" autocomplete="off">
		<!-- CSRF Token -->
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('nom') ? 'error' : '' }}}">
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="nom" id="nom" placeholder="{{ $servicio->nom }}" />
				...
				<div class="form-group {{{ $errors->has('descripcio') ? 'error' : '' }}}">
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="descripcio" id="descripcio" placeholder="{{ $servicio->descripcio }}" />
					...
					<div class="col-md-10">
						<input class="form-control" type="number" name="duracio" id="duracio" placeholder="{{ $servicio->duracio }}" />
					...
					<div class="col-md-10">
						<input class="form-control" type="number" name="punts" id="descripcio" placeholder="{{ $servicio->punts }}" />
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="punts" id="descripcio" placeholder="{{ $servicio->localitzacio }}" />
